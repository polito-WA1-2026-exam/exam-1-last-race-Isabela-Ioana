        ...
        <Container className="my-5 px-4" style={{ maxWidth: "800px" }}>
            ...
            <Accordion defaultActiveKey="0" flush className="shadow-lg border border-secondary border-opacity-25 rounded-3 overflow-hidden">
                ...
                <Accordion.Item eventKey="0" className="bg-dark text-black border-bottom border-secondary border-opacity-25">
                    ...
                    <Accordion.Body className="text-white-50 lh-lg" style={{ background: "#cdd9ec" }}>
                        The game logic operates strictly on a simplified model of the real Bucharest Metro network. 
                        You are required to map out a continuous journey consisting of 
                        <span className="fw-bold text-white"> at least 3 directly connected stations </span> 
                        from your database.
                        <br /><br />
                        <span className="text-warning fw-bold">The Golden Rule:</span> Switching from one subway line 
                        to another (e.g., from the Yellow Line M1 to the Red Line M3) is strictly illegal unless 
                        the transfer occurs at an <span className="fw-bold text-white">authorized interchange hub</span> 
                        (<i>Piața Victoriei, Piața Unirii, Dristor, or Nicolae Grigorescu</i>). Changing lines at 
                        any standard, single-line station will cause the backend server to flag your route as 
                        invalid instantly.
                    </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey="2" className="bg-dark text-black">
                    ...
                    <Accordion.Body className="text-white-50 lh-lg" style={{ background: "#cdd9ec" }}>
                        ...
                        <br />
                        If your balance drops below zero, or if the server deems your chosen routing illegal, you will face maximum penalties (a score of 0). To persist your achievements permanently in the <span className="fw-bold text-white">Global Leaderboard </span> database, ensure you hit the <span className="fw-bold text-white" >Sign In</span> button on the header layout before initiating your run.
                    </Accordion.Body>
                </Accordion.Item>
